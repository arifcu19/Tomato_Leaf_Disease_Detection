...
@section('mainpart')
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            ...
            <button class="btn btn-primary" data-toggle="modal" data-target="#AddCategoryModel">Add Category</button>
        </div>
        <div class="card-body">
                                ...
                                <form action="{{route('category.update', $category->id)}}" method="POST">
                                    ...
                                    <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('description') is-invalid @enderror " name="description" rows="7">{{ $category->description }}</textarea>
                                                @error('description')
            ...
            <div class="modal-content">
                ...
                <form action="{{route('category.store')}}" method="POST">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="category_name">Category Description</label>
                                <textarea class="form-control @error('name') is-invalid @enderror " name="description" rows="7">{{ old('description')}}</textarea>
                                @error('description')
